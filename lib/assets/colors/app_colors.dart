...
class AppColors {
  ...
  static const _brightSun = Color(0xFFFCDD3D);
  static const _flamingo = Color(0xFFEF4343);
  static const _martinique = Color(0xFF252849);
  static const _oxfordBlue = Color(0xFF3B3E5B);
  static const _waterloo = Color(0xFF7C7E92);
  static const _waterloo56op = Color(0x8F7C7E92);
  static const _wildSand = Color(0xFFF5F5F5);

  static const _pastelGreen = Color(0xFF6ADA6F);
  static const _kournikova = Color(0xFFFFE769);
  static const _persianRed = Color(0xFFCF2A2A);
  static const _shark = Color(0xFF1A1A20);
  static const _charade = Color(0xFF21222C);
}
